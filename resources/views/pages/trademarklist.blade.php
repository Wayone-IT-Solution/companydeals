      ...
      <div class="col-md-6 col-lg-4">
        <div class="card shadow-sm rounded-4 h-100 border-0">
          <div class="card-body d-flex flex-column">
            <h5 class="card-title fw-semibold text-primary mb-3 text-truncate" title="{{ $trademark->wordmark }}">
              {{ $trademark->wordmark }}
              <span class="badge bg-info text-dark ms-2 fs-7">Class {{ $trademark->class_no }}</span>
            </h5>
            ...
            <div class="mt-auto">
              <span class="fs-5 fw-bold text-success">
                ₹{{ number_format($trademark->ask_price) }} {{ $trademark->ask_price_unit }} / month
              </span>
            </div>
          </div>
