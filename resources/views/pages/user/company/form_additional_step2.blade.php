...
<fieldset class="scheduler-border pricewithunit">
    ...
    <div class="field">
        ...
        <input id="{{$eachTurnover['turnoverField']}}"  type="number" min="0" max="9999" class="form-control onlynumber fourdigit" name="{{$eachTurnover['turnoverField']}}" placeholder="Turnover for year {{$yr}}" {{$required}} value="{{$eachTurnover['turnover']}} "     title="If you have no turnover, enter '0'"
>
